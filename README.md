...
Daily log: BCA student building cybersecurity skills hands-on. Linux, networking, cloud security, TryHackMe, CTFs. Public evidence of progress.
# Day 1 — Linux Basics, Networking & First Wargame
...
- MAC Address – identifies the hardware on a local network.
